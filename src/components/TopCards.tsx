...
const TopCards: React.FC<CardStackProps> = ({ cardNumber }) => {
    const cardWidth = 140;

    return (
        <div className="inline-block">
            <div className="flex-shrink-0 m-4s relative rounded-lg shadow-lg bg-gradient-to-r from-orange-500 to-purple-500">
                ...
                <div className="relative text-white px-6 pb-6 mt-6">
                    <span className="block opacity-75 -mb-1">友方</span>
                </div>
            </div>
        </div>
    );
